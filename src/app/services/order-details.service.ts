...
export class OrderDetailsService {
  ...
  foodDetails = [
    ...
    },
    {
      ...
      foodDetails:
        "A homely mix of mashed potato and veggies, seasoned Indian spices. A filling sure to take you back to mom's kitchen",
      foodPrice: 140,
      foodImg:
    ...
    },
    {
      ...
      foodDetails:
        '(Eggless) Indulge in richly decadent chocolate brownie crafted with love ',
      foodPrice: 105,
      foodImg:
